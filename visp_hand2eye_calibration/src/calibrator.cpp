...
{
  RCLCPP_DEBUG(rclcpp::get_logger("rclcpp"), "new cMo: [%f,%f,%f -- %f,%f,%f,%f]", trans->translation.x,
...
{
  RCLCPP_DEBUG(rclcpp::get_logger("rclcpp"), "new wMe: [%f,%f,%f -- %f,%f,%f,%f]", trans->translation.x,
               trans->translation.y, trans->translation.z, trans->rotation.x, trans->rotation.y, trans->rotation.z,
               trans->rotation.w);
...
{
  visp_hand2eye_calibration::msg::TransformArray camera_object = req->qcamera_object;
...
Calibrator::Calibrator() : check_inputs_(ros::NodeHandle(), ros::this_node::getName()), queue_size_(1000)
{
  Calibrator::Calibrator(const rclcpp::NodeOptions &options)
    : Node("calibrator", options),
      ...
      queue_size_(1000)
  {
    ...
    compute_effector_camera_quick_service_ =
        this->create_service<visp_hand2eye_calibration::srv::ComputeEffectorCameraQuick>(
            ...
            std::bind(&Calibrator::computeEffectorCameraQuickCallback, this, std::placeholders::_1,
                      std::placeholders::_2, std::placeholders::_3));
    reset_service_ = this->create_service<visp_hand2eye_calibration::srv::Reset>(
        visp_hand2eye_calibration::reset_service, std::bind(&Calibrator::resetCallback, this, std::placeholders::_1,
                                                            std::placeholders::_2, std::placeholders::_3));
  }
